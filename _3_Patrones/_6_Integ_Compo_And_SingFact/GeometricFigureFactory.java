...
public class GeometricFigureFactory {
    ...
    public GeometricFigure createFigure(String code) throws GeometricFigureFactoryException {
        switch (code){
            case CODE_CIRCLE:
        ...
        throw new GeometricFigureFactoryException(code + " is not code valid...");
    }
